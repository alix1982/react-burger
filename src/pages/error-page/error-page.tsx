...
type ErrorPageProps = { errCode?: 400 | 403 | 500 };

export const ErrorPage = ({ errCode = 403 }: ErrorPageProps): React.ReactNode => {
  ...
  const handleAction = (): void | Promise<void> => navigate(-1);
