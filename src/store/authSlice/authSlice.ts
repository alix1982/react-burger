...
>('auth/register', async (dataRegister) => {
...
export const authSlice = createSlice({
  ...
  extraReducers: (builder) => {
    ...
    builder.addCase(changePassword.fulfilled, (state) => {
      ...
      state.isLoadingForgotPassword = false;
      state.errorForgotPassword = '';
      localStorage.setItem('isChangePassword', String(true));
    });
...
export const SisAuthChecked = (state: RootState): boolean => state.auth.isAuthChecked;
export const SuserAuth = (state: RootState): User | null => state.auth.user;
export const SisLoadingRegister = (state: RootState): boolean =>
  state.auth.isLoadingRegister;
export const SerrorRegister = (state: RootState): string => state.auth.errorRegister;
export const SisLoadingLogin = (state: RootState): boolean => state.auth.isLoadingLogin;
export const SerrorLogin = (state: RootState): string => state.auth.errorLogin;
export const SisLoadingForgotPassword = (state: RootState): boolean =>
  state.auth.isLoadingForgotPassword;
export const SerrorForgotPassword = (state: RootState): string =>
  state.auth.errorForgotPassword;
export const SisLoadingResetPassword = (state: RootState): boolean =>
  state.auth.isLoadingResetPassword;
export const SerrorResetPassword = (state: RootState): string =>
  state.auth.errorResetPassword;
export const StextLogout = (state: RootState): string => state.auth.textLogout;
export const SisLoadingLogout = (state: RootState): boolean =>
  state.auth.isLoadingLogout;
export const SerrorLogout = (state: RootState): string => state.auth.errorLogout;
// export const {
//   SisAuthChecked,
//   SuserAuth,
//   SisLoadingRegister,
